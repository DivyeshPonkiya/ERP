...
export const fetchCustomerCreate = createPostThunk('CustomerCreate');
export const fetchCustomerUpdate = createPatchThunk('CustomerUpdate');
export const fetchCustomerList = createGetThunk('fetchCustomerList');
export const fetchCustomerDetail = createGetThunk('fetchCustomerDetail');
export const fetchCustomerDelete = createDeleteThunk('fetchCustomerDelete');
export const fetchCustomerSearch = createGetThunk('CustomerSearch');
