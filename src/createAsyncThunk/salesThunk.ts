...
export const fetchSalesCreate = createPostThunk('SalesCreate');
export const fetchSalesUpdate = createPatchThunk('SalesUpdate');
export const fetchSalesList = createGetThunk('SalesList');
export const fetchSalesDetail = createGetThunk('SalesDetail');
export const fetchSalesDelete = createDeleteThunk('SalesDelete');
